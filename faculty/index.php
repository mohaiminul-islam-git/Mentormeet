...
<tr class="menu-row">
    ...
    <td colspan="4">
        <center>
            <div class="welcome-box" style="background: rgba(255, 255, 255, 0.15); 
                                           backdrop-filter: blur(10px); 
                                           -webkit-backdrop-filter: blur(10px); 
                                           border-radius: 20px; 
                                           border: 1px solid rgba(255, 255, 255, 0.12); 
                ...
                <p>
                    ...
                    You can view your daily schedule, Reach Students Appointment at home!
                </p>
                <a href="appointment.php" class="non-style-link">
                    <button class="btn-primary btn" style="width:70%">View My Appointments</button>
                </a>
            </div>
            <br>
        </center>
                                ...
                                <td width="50%">
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px; position: relative; top:10px;">Status</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
    ...
    <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex;">
        ...
        <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/patients-hover.svg');"></div>
                                ...
                                <td>
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;margin-top:-65px;">Your Up Coming Sessions until Next week</p>
                                    <center>
