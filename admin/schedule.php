...
<tr class="menu-row">
    <td class="menu-btn menu-icon-schedule menu-active menu-icon-dashbord-active">
        <a href="schedule.php" class="non-style-link-menu">
            <div style="display: flex; align-items: center;">
                ...
                <p class="menu-text" style="margin-left:-125px; color: #1E90FF; font-weight: 600;">Schedule</p>
            </div>
        </a>
    </td>
</tr>
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        <td style="text-align:center;">
                                            ' . substr($scheduledate, 0, 40) . ' | ' . substr($scheduletime, 0, 10) . '
                                        </td>
                                        <td style="text-align:center;">
                                            ' . $nop . '
                                        </td>
