...
/* Only Book Now hover effect */
.btn-book:hover {
    background-color: #007bff;  /* darker blue background */
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    <p class="profile-title"><?php echo substr($username, 0, 60)  ?></p>
                                    <p class="profile-subtitle"><?php echo substr($useremail, 0, 60)  ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <form action="schedule.php" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Faculty name or Email or Date (YYYY-MM-DD)" list="doctors">&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Faculty Name:  &nbsp;&nbsp;<b>' . $docname . '</b><br>
                                                            Faculty Email:  &nbsp;&nbsp;<b>' . $docemail . '</b> 
                                                        </div>
                                        ...
                                        <td style="width: 25%;">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%;padding-top: 15px;padding-bottom: 15px;">
                                                        <div class="h1-search" style="font-size:20px;line-height: 35px;margin-left:8px;margin-top:-10px; text-align:center;">
                                                            Your Appointment Number
                                                        </div>
                                                        <center>
                                                        <div class=" dashboard-icons" style="margin-left: 0px;margin-left: 0px;width:90%;font-size:70px;font-weight:800;text-align:center;color:var(--btnnictext);background-color: var(--btnice)">' . $apponum . '</div>
                                                    </center>
